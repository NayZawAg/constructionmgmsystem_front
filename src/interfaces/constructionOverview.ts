export interface ConstructionOverview {
  ...
  company_implementation_date: string;
  con_rev_meeting_by_wor_type: number;
  con_rev_meeting_by_wor_type_implementation_date: string;
  safety_quality_patrol: number;
  safety_quality_patrol_implementation_date: string;
  basic_con_plan_document: boolean;
  con_rev_meeting: number;
  con_rev_meeting_implementation_date: string;
  head_office_manager_interview_date: string;
}
